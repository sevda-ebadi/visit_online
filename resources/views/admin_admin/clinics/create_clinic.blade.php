...
@section('body')
    <div class="az-content">
        <div class="container">
            <form method="post" action="{{ route('clinics.store') }}" class="az-content-body">
                @csrf
                ...
                <div class="row row-sm mg-b-20">
                    <div class="col-lg">
                        ...
                        <textarea name="address" style="text-align: right" rows="3" class="form-control" placeholder="ادرس">{{ old('address') }}</textarea>
                    </div><!-- col -->
                </div><!-- row -->
