...
<?php $__env->startSection('body'); ?>
    <div class="az-content">
        <div class="container">
            <form method="post" action="<?php echo e(route('clinics.store')); ?>" class="az-content-body">
                <?php echo csrf_field(); ?>
                <div style="display: flex;justify-content: space-between">
                    ...
                    <h2 class="az-content-title"> ثبت کلینیک جدید </h2>
                </div>
                ...
                <div class="row row-sm mg-b-20">
                    <div class="col-lg">
                        ...
                        <textarea name="address" style="text-align: right" rows="3" class="form-control" placeholder="ادرس"><?php echo e(old('address')); ?></textarea>
                    </div><!-- col -->
                </div><!-- row -->
...
<?php echo $__env->make('admin_admin.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hamid\Desktop\asp\P_database\resources\views/admin_admin/clinics/create_clinic.blade.php ENDPATH**/ ?>